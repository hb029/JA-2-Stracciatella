...
void HandleLeavingOfEquipmentInCurrentSector(SOLDIERTYPE& s)
{
	...
	FOR_EACH_SOLDIER_INV_SLOT(i, s)
	{
		...
		{
			AddItemsToUnLoadedSector(s.sSectorX, s.sSectorY, s.bSectorZ, gridno, 1, i, s.bLevel, WORLD_ITEM_FIND_SWEETSPOT_FROM_GRIDNO | WORLD_ITEM_REACHABLE, 0, VISIBLE);
		}
	}
