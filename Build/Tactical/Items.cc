...
const INVTYPE Item[] =
{
	...
	{	IC_GUN,			 			7,			TARGETCURS,	0,		7,		17,	1,		 300,	1,		/* .357 DesertEagle*/ -1,		-1,			IF_STANDARD_GUN | ITEM_BIGGUNLIST },
	{	IC_GUN,			 			8,			TARGETCURS,	0,		8,		11,	1,		 400,	2,		/* .45 M1911		 */  0,		0,			IF_STANDARD_GUN },
	...
	{	IC_AMMO,					15,			INVALIDCURS,	1,		11,		1,	8,		  10,	1,		/* CLIP357_6 */				0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},
	{	IC_AMMO,					16,			INVALIDCURS,	1,		17,		3,	8,			15,	1,		/* CLIP357_9 */				0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},
	{	IC_AMMO,					17,			INVALIDCURS,	1,		12,		1,	8,		  30,	3,		/* CLIP357_6_AP */		0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},
	{	IC_AMMO,					18,			INVALIDCURS,	1,		18,		3,	8,		  45,	3,		/* CLIP357_9_AP */		0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},
	{	IC_AMMO,					19,			INVALIDCURS,	1,		13,		1,	8,		  20,	2,		/* CLIP357_6_HP */		0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},

	{	IC_AMMO,					20,			INVALIDCURS,	1,		19,		3,	8,		  30,	2,		/* CLIP357_9_HP */		0,		0,			IF_STANDARD_CLIP | ITEM_BIGGUNLIST},
	...
	{ IC_KIT,					0,			INVALIDCURS,	1,		78,		3,	1,		 250,	3,	  /* Locksmith kit */		0,		-2,			IF_STANDARD_KIT | ITEM_METAL},
	...
	{	IC_MISC,				0,			INVALIDCURS,	1,		70,		1,	6,		 300,	6,		/* Regen Booster */		0,		0,			ITEM_DAMAGEABLE | ITEM_UNAERODYNAMIC | WORLD_ITEM_SCIFI_ONLY}, //HB: no regen booster on realistic
...
static const AttachmentInfoStruct AttachmentInfo[] =
{
	...
	{ ELASTIC,					IC_NONE,		NO_CHECK,									0},
	{ DISPLAY_UNIT,             IC_NONE,		ATTACHING_SPECIAL_ELECTRONIC_ITEM_CHECK,	-30 },
	{ COPPER_WIRE,				IC_NONE,		ATTACHING_SPECIAL_ELECTRONIC_ITEM_CHECK,	+20 },
	{ CERAMIC_PLATES,			IC_ARMOUR,		NO_CHECK,									0 },
	{ CLIP545_30_AP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP545_30_HP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP556_30_AP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP556_30_HP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP762W_30_AP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP762W_30_HP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP762N_20_AP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP762N_20_HP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIP57_50_AP,				IC_NONE,		NO_CHECK,									0 },
	{ CLIP57_50_HP,				IC_NONE,		NO_CHECK,									0 },
	{ CLIPCAWS_10_SAP,			IC_NONE,		NO_CHECK,									0 },
	{ CLIPCAWS_10_FLECH,		IC_NONE,		NO_CHECK,									0 },
	{ NONE,                     0,          0,                                            0 }
};
...
{ // first item			second item						resulting item,					merge type
	...
	//HB: limit this by the available elastics
...
ComboMergeInfoStruct AttachmentComboMerge[] =
{
	...
	{FLASH_DEVICE,							{DISPLAY_UNIT,						ELASTIC},							XRAY_DEVICE},
...
{
	{ BARRACUDA,		SW38	}, //HB: one ammo type less
	{ DESERTEAGLE,		M1911	}, //HB: one ammo type less
...
{
	{ CLIP357_6,			CLIP38_6  },
	{ CLIP357_6_AP,			CLIP38_6_AP  },
	{ CLIP357_6_HP,			CLIP38_6_HP  },
	{ CLIP357_9,			CLIP45_7  },
	{ CLIP357_9_AP,			CLIP45_7_AP  },
	{ CLIP357_9_HP,			CLIP45_7_HP  }, //HB: one ammo type less
...
void CreateItem(UINT16 const usItem, INT8 const bStatus, OBJECTTYPE* const pObj)
{
	...
	{
		//HB: handle ammo attachments, hack
		CreateMagazine(usItem, pObj);
		if (bStatus != 100) pObj->ubShotsLeft[0] = bStatus;
	}
	else
	{
		pObj->usItem = usItem;
