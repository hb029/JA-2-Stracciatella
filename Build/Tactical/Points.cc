...
void UnusedAPsToBreath(SOLDIERTYPE *pSold)
{
	...
	else
	{
		...
		//HB: running is canceled when ap are left at turns end
		if ( (pSold->usAnimState == RUNNING) && (pSold->bActionPoints > AP_START_RUN_COST) )
		{
			EVENT_InitNewSoldierAnim( pSold, STANDING, 0 , TRUE );
		}
