...
void DrawItemUIBarEx(OBJECTTYPE const& o, const UINT8 ubStatus, const INT16 x, const INT16 y, INT16 max_h, const INT16 sColor1, const INT16 sColor2, SGPVSurface* const uiBuffer)
{
	...
	{
		//HB: take care of ammo attachments
		if (Item[o.usAttachItem[ubStatus - DRAW_ITEM_STATUS_ATTACHMENT1]].usItemClass & IC_AMMO)
		{
			value = 100 * o.bAttachStatus[ubStatus - DRAW_ITEM_STATUS_ATTACHMENT1] / Magazine[Item[o.usAttachItem[ubStatus - DRAW_ITEM_STATUS_ATTACHMENT1]].ubClassIndex].ubMagSize;
