...
//HB: repairing cap: you can't repair any item beyond this value
#define REAPAIR_RATING_CAP	85
//HB: repairing cap: shops can't repair any item beyond this value
#define SHOP_REAPAIR_RATING_CAP	85
//HB: healing cap: you can't heal any merc beyond this cap
#define DOCTOR_RATING_CAP	85
//HB: healing cap: hospital can't heal any merc beyond this cap
#define HOSPITAL_RATING_CAP	85
//HB: skill check cap: defusing, building a bomb etc. might go wrong
#define SKILLCHECK_CAP		85
