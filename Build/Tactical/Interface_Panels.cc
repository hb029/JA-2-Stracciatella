...
void SetSMPanelCurrentMerc(SOLDIERTYPE* s)
{
	...
	{
		if (gpItemPointer || guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE || s->bLife < OKLIFE)
		{
...
static void SelectMerc(SOLDIERTYPE* const s)
{
	...
	if (guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE && InItemDescriptionBox())
	{
		DeleteItemDescriptionBox();
	}
}
