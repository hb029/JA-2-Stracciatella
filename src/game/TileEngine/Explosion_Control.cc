	...
	switch( pObj->bActionValue )
	{
		...
		case ACTION_ITEM_EXIT_BROTHEL:
			if ( ! (gTacticalStatus.uiFlags & INCOMBAT) )
			{
				...
				if (tgt != NULL && tgt->bTeam == OUR_TEAM && tgt->sOldGridNo == sGridNo + DirectionInc(NORTH))
				{
					...
					SetCustomizableTimerCallbackAndDelay(1000, BillyBlocksDoorCallback, FALSE);
				}
			}
			break;
		...
		case ACTION_ITEM_SEX:
			...
			else
			{
				...
				{
				case 12290:
					sDoorSpot = 12290; // Carla
					sTeleportSpot = 12291;
					break;
				case 13414:
					sDoorSpot = 13413; // Cindy
					sTeleportSpot = 13413;
					break;
				case 11174:
					sDoorSpot = 11173; // Bambi
					sTeleportSpot = 11173;
					break;
				//case xxxxx:
				//	sDoorSpot = 10852; // Maria
				//	sTeleportSpot = 10852;
				//	break;
				default:
					sDoorSpot = NOWHERE;
